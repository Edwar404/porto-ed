<nav class="navbar navbar-expand-md navbar-fixed-top navigation-clean-button navbar-light w-100" style="background: #1E201E;">
            <div class="container">
                <div><a class="navbar-brand" href="#"> <img src="" width="125" height="124"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1" style="color: #47db48;background: #47db48;"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon" style="color: #47db48;"></span></button></div>
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="navbar-nav nav-right" style="font-family: 'Mochiy Pop P One', sans-serif;">
                        <li class="nav-item"><a class="nav-link active" href="index.html" style="color: #47db48;">Home </a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="about.html" style="color: #47db48;">About </a></li>
                        <li class="nav-item"></li>
                        <li class="nav-item"><a class="nav-link" href="contact.html" style="color: #47db48;">Contact </a></li>
                    </ul>
